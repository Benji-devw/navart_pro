  ...
  const experiences = [
    {
      ...
      description: "Développement d'applications React et Node.js, gestion d'équipe, mise en place d'architectures microservices."
    },
    {
      id: 2,
      date: "2020 - 2022",
      ...
      description: "Création d'interfaces utilisateur interactives avec React, intégration d'API RESTful, optimisation de performances."
    },
    {
      id: 3,
      date: "2018 - 2020",
    ...
    },
    {
      ...
      description: "Intégration de maquettes, développement de sites web responsifs, initiation aux frameworks JavaScript."
    }
  ];
